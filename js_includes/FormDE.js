...
jqueryWidget: {
    _init: function () {
        ...
        this.continueMessage = dget(this.options, "continueMessage", "Hier klicken, um fortzufahren");
        ...
        this.obligatoryErrorGenerator =
            dget(this.options, "obligatoryErrorGenerator",
                 function (field) { return "\u2018" + field + "\u2019 ist ein Pflichtfeld."; });
        ...
        this.obligatoryRadioErrorGenerator =
            dget(this.options, "obligatoryRadioErrorGenerator",
                 function (field) { return "Sie müssen eine Option für \u2018" + field + "\u2019 auswählen."; });
		...
		function setCaretPosition(ctrl, pos) { // the function to set cursor position is this, but I don't know where to put it
		  // Modern browsers
		...
		var cursor = document.getElementById( dget(this.options, "focusID") );
		if (cursor)  setCaretPosition(cursor, 0);		
